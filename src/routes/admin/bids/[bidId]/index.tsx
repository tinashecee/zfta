...
export default component$(() => {
  ...
  const b = bid.value as any;

  return (
    <div class="min-h-screen bg-background text-on-background">
      <AdminPortalNav activeItem="bids" />

      <main class="min-h-screen pt-20 lg:pl-64">
        <div class="mx-auto flex max-w-4xl flex-col gap-6 px-4 py-8 sm:px-6 lg:p-10">
          <nav class="text-sm text-on-surface-variant">
            <a class="font-semibold text-primary hover:underline" href="/admin/bids/">
              Submitted bids
            </a>
          ...
          {loading.value ? (
            ...
            <>
              ...
              <section class="rounded-2xl border border-outline-variant/15 bg-white p-6 shadow-sm">
                <h2 class="text-lg font-bold text-primary">Admin actions</h2>
                ...
                <div class="mt-6 border-t border-outline-variant/20 pt-6">
                  ...
                  <div class="mt-4 space-y-4">
                    <div>
                      <label class="block text-sm font-semibold text-on-surface-variant mb-2" for="infoMessageAdmin">
                        Message
                      </label>
                      <textarea
                        id="infoMessageAdmin"
                    ...
                    <div>
                      <label class="block text-sm font-semibold text-on-surface-variant mb-2" for="infoDeadlineAdmin">
                        Deadline
                      </label>
                      <input
                        id="infoDeadlineAdmin"
                        type="datetime-local"
