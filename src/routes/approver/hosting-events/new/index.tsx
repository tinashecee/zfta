...
export default component$(() => {
  ...
  useVisibleTask$(() => {
    ...
    if (denied) window.location.assign(denied);
  });
  ...
  return (
    <div class="flex flex-1 flex-col min-h-0 min-w-0 bg-background text-on-background">
      <ApproverPortalNav activeItem="hostingEventsManage" title="Create hosting event · SRC" />
        ...
        <div class="mx-auto flex max-w-3xl flex-col gap-6">
          <header>
            ...
            <p class="mt-2 text-on-surface-variant text-sm">
              Creates <code class="text-xs font-mono">POST /api/hosting/events</code>. Optionally publish immediately.
            </p>
          </header>
          ...
          <form preventdefault:submit onSubmit$={onSubmit$} class="space-y-5">
            ...
            <label class="flex items-start gap-3">
              ...
              />
              <span class="text-sm text-on-surface">Open for bids immediately (publish after create)</span>
            </label>
...
export const head: DocumentHead = {
  title: "Create hosting event | Approver",
};
